...
import net.lukas.tutorialmod.block.custom.EggPlantCropBlock;
import net.lukas.tutorialmod.block.custom.JumpyBlock;
import net.lukas.tutorialmod.block.custom.TanzaniteLampBlock;
import net.lukas.tutorialmod.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block TANZANITE_ORE = registerBlock("tanzanite_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(4f).requiresTool(),
                    UniformIntProvider.create(100, 1000)), ModItemGroup.TANZANITE);
    ...
    public static final Block TANZANITE_LAMP = registerBlock("tanzanite_lamp",
            new TanzaniteLampBlock(FabricBlockSettings.of(Material.GLASS).strength(4f).requiresTool().luminance(state -> state.get(TanzaniteLampBlock.LIT) ? 15 : 0)), ModItemGroup.TANZANITE);
